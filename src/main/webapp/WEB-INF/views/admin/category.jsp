...
<div class="row">
    ...
    <div class="col-md-7 col-xs-12">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-xs-3"><h3>Add subcategory</h3></div>
        ...
        <c:forEach items="${page.content}" var="category">
            <div class="row">
                ...
                <div class="col-md-3 col-xs-3"><a class="btn btn-success" href="/admin/subcategory/add/${category.id}">Add</a></div>
