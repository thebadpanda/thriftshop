...
<div class="col-md-7 col-xs-12">
        ...
        <div class="row">
            ...
            <div class="col-md-2 col-xs-2"><h3>Add subcategory</h3></div>
        ...
        <c:forEach items="${categories}" var="category">
            <div class="row">
                ...
                <div class="col-md-2 col-xs-2"><a class="btn btn-success" href="/admin/subcategory/add/${category.id}">Add</a></div>
