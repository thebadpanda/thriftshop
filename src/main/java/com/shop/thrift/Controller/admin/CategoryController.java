...
public class CategoryController {
    ...
    public String delete(@PathVariable int id, @PageableDefault Pageable pageable) {
        ...
        return "redirect:/admin/category"+getParams(pageable);
    }
    ...
    public String save(@ModelAttribute("category") @Valid Category category, BindingResult br,
                       SessionStatus status, Model model, @PageableDefault Pageable pageable) {
        if (br.hasErrors()) {
            model.addAttribute("page", categoryService.findAll());
            return "admin-category";
        }
